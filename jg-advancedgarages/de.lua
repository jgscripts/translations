...
Locales['de'] = {
  ...
  impoundInformation = "Abschlepp-Information",
  impoundedBy = "Beschlagnahmt von",
  impoundedReason = "Grund",
  impoundPlayerCanCollect = "Fahrzeug kann am Abschlepphof ausgelöst werden",
  impoundCollectionContact = "Kontaktiere %{value} um dein Fahrzeug auszulösen",
  impoundNoVehicles = "Keine Fahrzeuge im Abschlepphof",
  ...
  garageNameExistsError = "Garagenname existiert bereites",
  vehiclePlateExistsError = "Kennzeichen existiert bereites",
  ...
  vehicleImpoundRemoveSuccess = "Fahrzeug wurde aus dem Abschlepphof ausgelöst",
  ...
  cmgArgMinGangRank = "Mindester Gangrang",
  cmgArgMinJobRank = "Mindester Jobrang",
  ...
  -- v3
  vehicleStoreError = "Du kannst das Fahrzeug hier nicht einlagern",
  mins = "Min",
  noVehiclesAvailableToDrive = "Es sind keine Fahrzeuge verfügbar",
}
