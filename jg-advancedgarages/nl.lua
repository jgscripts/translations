...
Locales['nl'] = {
  ...
  insertVehiclePublicError = "Je kunt geen bedrijfs- of bendevoertuigen opslaan in openbare garages",
  ...
  invalidJobError = "Je heeft geen geldige bedrijfs opgegeven",
  ...
  vehicleAddedToJobGarageSuccess = "Voertuig toegevoegd aan de %{value} bedrijfs garage!",
  ...
  cmdSetJobVehicle = "Huidig voertuig toevoegen aan een bedrijfsgarage",
  cmdRemoveJobVehicle = "Stel bedrijfsvoertuig terug in als eigendom van de speler",
