...
Locales["en"] = {
  ...
  orderVehicleDisconnectRequiredTitle = "Enter vehicle required",
  orderVehicleDisconnectRequired = "You need to get into the vehicle to disconnect it.",
  enterVehicleToDisconnectOrderVehicleMsg = "Get into the vehicle's driver seat to disconnect it",
  driverSeatToDisconnectOrderVehicleError = "You need to be in the driver's seat to disconnect this vehicle",
  vehicleDisconnected = "Vehicle disconnected successfully",
