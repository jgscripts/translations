...
Locales["en"] = {
  ...
  enterVehicleToInstallOrderMsg = "Get into the vehicle's driver seat to finish the installation",
  driverSeatToInstallOrderError = "You need to be in the driver's seat to finish this installation",
