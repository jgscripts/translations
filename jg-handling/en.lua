...
Locales["en"] = {
  ...
  mechanicDataModeExplain = "This vehicle's handling has modified by JG Mechanic. You can choose to edit the handling as-is (option 1), edit the handling without any modifications (option 3), or just without servicing damage (option 2).",
