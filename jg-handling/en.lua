...
Locales["en"] = {
  ...
  handlingNameNeedsChecking = "Check the handling name",
  handlingNameWarning = "Handling names can't be detected reliably. Check or edit this value before copying the XML.",
  missingHandlingName = "Enter a handling name",
  deleting = "Deleting...",
