...
Locales['fr'] = {
  ...
  down = "Bas",
  confirm = "Confirmer",
  editPolygonVertices = "Modifier les sommets du polygone",
  walkToEachPointCreateZone = "Allez à chaque point et ajoutez-le pour créer une zone",
  selectPoint = "Sélectionner le point",
  ...
  dealershipNameTooLong = "Le nom de la concession ne peut pas dépasser 100 caractères.",
  generalSettings = "Général",
  invalidCommission = "Saisissez une commission comprise entre 0 et 100.",
  savingChanges = "Enregistrement des modifications...",
  automaticallySaved = "Enregistré automatiquement",
  settingsUpdateFailed = "Les paramètres généraux n'ont pas pu être enregistrés.",
  ...
  commissionPaymentFailed = "La commission n'a pas pu être versée car le solde de la concession est insuffisant.",
  setupJob = "Configurer le métier",
  setupJobDesc = "Associez cette concession à un métier du framework et configurez les permissions des grades",
  setupJobOptionalDesc = "Associez éventuellement les rôles de la concession à un métier du framework",
  jobSetupRequired = "Vous devez configurer un métier avant de continuer",
  jobMustBeValidated = "Le métier n'a pas pu être validé ; vérifiez son nom",
  jobSummaryPerms = "%s permissions réparties sur %s grades",
  jobSummaryRoles = "%s rôles associés aux grades du métier",
  noPermissionsAssigned = "Aucune permission attribuée pour le moment",
  usedVehiclesMenu = "Véhicules d'occasion",
  vehicleType = "Type de véhicule",
  newVehicle = "Neuf",
  usedVehicle = "Occasion",
  usedVehiclesStockMenu = "Véhicules d'occasion",
  usedVehiclesPendingStockMenu = "Stock d'occasion en attente",
  usedVehiclesAuctionsMenu = "Enchères",
  usedVehiclesOffersMenu = "Offres",
  openUsedVehiclesManagement = "Ouvrir la gestion des véhicules d'occasion",
  usedVehiclesIntegrationUnavailable = "JG Used Vehicles n'est pas disponible actuellement.",
  usedVehiclesOpenFailed = "La gestion des véhicules d'occasion n'a pas pu être ouverte.",
  usedVehiclesTradeIns = "Reprises",
  usedVehiclesTradeInsEnabled = "Activer les reprises pour les ventes directes",
  usedVehiclesAllowFinancePayoffTradeIns = "Autoriser la reprise de véhicules financés",
  usedVehiclesMaxTradeInAppraisal = "Estimation maximale de reprise",
  failedToSaveDealership = "La concession n'a pas pu être enregistrée. Veuillez réessayer.",
  newVehicles = "Véhicules neufs",
  newVehiclesDescription = "Parcourez et achetez le stock neuf de la concession.",
  displayDivisionNew = "Neuf",
  displayDivisionUsed = "Occasion",
  vehiclesSold = "véhicules vendus",
  photos = "Photos",
  takePhoto = "Prendre des photos",
}
