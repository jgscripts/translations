...
Locales['ar'] = {
  ...
  down = "أسفل",
  confirm = "تأكيد",
  editPolygonVertices = "تحرير رؤوس المضلع",
  walkToEachPointCreateZone = "انتقل إلى كل نقطة وأضفها لإنشاء منطقة",
  selectPoint = "تحديد النقطة",
  removeSelected = "إزالة المحدد",
  adjustHeight = "ضبط الارتفاع",
  moveSelected = "نقل المحدد",
  keySpace = "مسافة",
  keyBackspace = "مسح للخلف",
  keyScroll = "عجلة التمرير",
  keyEnter = "إدخال",
  keyEscape = "Esc",
  keyLeftRight = "يسار / يمين",
  expand = "توسيع",
  collapse = "طي",
  ...
  dealershipNameTooLong = "لا يمكن أن يتجاوز اسم الوكالة 100 حرف.",
  generalSettings = "عام",
  invalidCommission = "أدخل عمولة بين 0 و100.",
  savingChanges = "جارٍ حفظ التغييرات...",
  automaticallySaved = "يُحفظ تلقائيًا",
  settingsUpdateFailed = "تعذر حفظ الإعدادات العامة.",
  unsavedChanges = "لديك تغييرات غير محفوظة",
  unsavedChangesDescription = "هل تريد الخروج بالتأكيد؟ ستفقد جميع التغييرات غير المحفوظة.",
  keepEditing = "متابعة التعديل",
  discardChanges = "تجاهل التغييرات",
  commissionPaymentFailed = "تعذر دفع العمولة لأن رصيد الوكالة منخفض جدًا.",
  setupJob = "إعداد الوظيفة",
  setupJobDesc = "اربط هذه الوكالة بوظيفة في إطار العمل واضبط صلاحيات الرتب",
  setupJobOptionalDesc = "اربط أدوار الوكالة اختياريًا بوظيفة في إطار العمل",
  jobSetupRequired = "يجب إعداد وظيفة قبل المتابعة",
  jobMustBeValidated = "تعذر التحقق من الوظيفة - تحقق من اسمها",
  jobSummaryPerms = "%s صلاحية عبر %s رتبة",
  jobSummaryRoles = "%s دور مرتبط برتب الوظيفة",
  noPermissionsAssigned = "لم تُعيّن أي صلاحيات بعد",
  usedVehiclesMenu = "المركبات المستعملة",
  vehicleType = "نوع المركبة",
  newVehicle = "جديدة",
  usedVehicle = "مستعملة",
  usedVehiclesStockMenu = "المركبات المستعملة",
  usedVehiclesPendingStockMenu = "مخزون مستعمل قيد الانتظار",
  usedVehiclesAuctionsMenu = "المزادات",
  usedVehiclesOffersMenu = "العروض",
  openUsedVehiclesManagement = "فتح إدارة المركبات المستعملة",
  usedVehiclesIntegrationUnavailable = "JG Used Vehicles غير متاح حاليًا.",
  usedVehiclesOpenFailed = "تعذر فتح إدارة المركبات المستعملة.",
  usedVehiclesTradeIns = "الاستبدال",
  usedVehiclesTradeInsEnabled = "تفعيل الاستبدال للمبيعات المباشرة",
  usedVehiclesAllowFinancePayoffTradeIns = "السماح باستبدال المركبات الممولة",
  usedVehiclesMaxTradeInAppraisal = "الحد الأقصى لتقييم الاستبدال",
  failedToSaveDealership = "تعذر حفظ الوكالة. حاول مرة أخرى.",
  newVehicles = "مركبات جديدة",
  newVehiclesDescription = "تصفح واشترِ مخزون الوكالة الجديد.",
  displayDivisionNew = "جديدة",
  displayDivisionUsed = "مستعملة",
  vehiclesSold = "مركبة مباعة",
  photos = "الصور",
  takePhoto = "التقاط صور",
}
