...
Locales['de'] = {
  ...
  down = "Runter",
  confirm = "Bestätigen",
  editPolygonVertices = "Polygonpunkte bearbeiten",
  walkToEachPointCreateZone = "Gehe zu jedem Punkt und füge ihn hinzu, um eine Zone zu erstellen",
  ...
  -- v2: Common dropdown
  selectOne = "Auswählen",
  dealershipNameTooLong = "Der Name des Autohauses darf höchstens 100 Zeichen lang sein.",
  generalSettings = "Allgemein",
  invalidCommission = "Gib eine Provision zwischen 0 und 100 ein.",
  savingChanges = "Änderungen werden gespeichert...",
  automaticallySaved = "Automatisch gespeichert",
  settingsUpdateFailed = "Die allgemeinen Einstellungen konnten nicht gespeichert werden.",
  ...
  commissionPaymentFailed = "Die Provision konnte nicht bezahlt werden, da das Guthaben des Autohauses zu niedrig ist.",
  setupJob = "Beruf einrichten",
  setupJobDesc = "Verknüpfe dieses Autohaus mit einem Framework-Beruf und konfiguriere Rangberechtigungen",
  setupJobOptionalDesc = "Verknüpfe Autohausrollen optional mit einem Framework-Beruf",
  jobSetupRequired = "Du musst einen Beruf einrichten, bevor du fortfahren kannst",
  jobMustBeValidated = "Der Beruf konnte nicht überprüft werden – prüfe den Berufsnamen",
  jobSummaryPerms = "%s Berechtigungen über %s Ränge",
  jobSummaryRoles = "%s Rollen mit Berufsrängen verknüpft",
  noPermissionsAssigned = "Noch keine Berechtigungen zugewiesen",
  usedVehiclesMenu = "Gebrauchtwagen",
  vehicleType = "Fahrzeugtyp",
  newVehicle = "Neu",
  usedVehicle = "Gebraucht",
  usedVehiclesStockMenu = "Gebrauchtwagen",
  usedVehiclesPendingStockMenu = "Ausstehender Gebrauchtbestand",
  usedVehiclesAuctionsMenu = "Auktionen",
  usedVehiclesOffersMenu = "Angebote",
  openUsedVehiclesManagement = "Gebrauchtwagenverwaltung öffnen",
  usedVehiclesIntegrationUnavailable = "JG Used Vehicles ist derzeit nicht verfügbar.",
  usedVehiclesOpenFailed = "Die Gebrauchtwagenverwaltung konnte nicht geöffnet werden.",
  usedVehiclesTradeIns = "Inzahlungnahmen",
  usedVehiclesTradeInsEnabled = "Inzahlungnahmen für Direktverkäufe aktivieren",
  usedVehiclesAllowFinancePayoffTradeIns = "Finanzierte Inzahlungnahmen erlauben",
  usedVehiclesMaxTradeInAppraisal = "Maximale Inzahlungnahmebewertung",
  failedToSaveDealership = "Das Autohaus konnte nicht gespeichert werden. Bitte versuche es erneut.",
  newVehicles = "Neufahrzeuge",
  newVehiclesDescription = "Durchsuche und kaufe neue Fahrzeuge des Autohauses.",
  displayDivisionNew = "Neu",
  displayDivisionUsed = "Gebraucht",
  vehiclesSold = "verkaufte Fahrzeuge",
  photos = "Fotos",
  takePhoto = "Fotos aufnehmen",
}
