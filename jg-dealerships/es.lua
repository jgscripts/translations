...
Locales['es'] = {
  ...
  down = "Abajo",
  confirm = "Confirmar",
  editPolygonVertices = "Editar vértices del polígono",
  walkToEachPointCreateZone = "Ve a cada punto y añádelo para crear una zona",
  ...
  keyScroll = "Rueda del ratón",
  keyEnter = "Intro",
  keyEscape = "Esc",
  keyLeftRight = "Izquierda / Derecha",
  expand = "Expandir",
  collapse = "Contraer",
  ...
  dealershipNameTooLong = "El nombre del concesionario no puede superar los 100 caracteres.",
  generalSettings = "General",
  invalidCommission = "Introduce una comisión entre 0 y 100.",
  savingChanges = "Guardando cambios...",
  automaticallySaved = "Guardado automáticamente",
  settingsUpdateFailed = "No se pudieron guardar los ajustes generales.",
  unsavedChanges = "Tienes cambios sin guardar",
  unsavedChangesDescription = "¿Seguro que quieres salir? Se perderán todos los cambios sin guardar.",
  keepEditing = "Seguir editando",
  discardChanges = "Descartar cambios",
  commissionPaymentFailed = "No se pudo pagar la comisión porque el saldo del concesionario es demasiado bajo.",
  setupJob = "Configurar trabajo",
  setupJobDesc = "Vincula este concesionario a un trabajo del framework y configura los permisos por rango",
  setupJobOptionalDesc = "Vincula opcionalmente los roles del concesionario a un trabajo del framework",
  jobSetupRequired = "Debes configurar un trabajo antes de continuar",
  jobMustBeValidated = "No se pudo validar el trabajo; comprueba su nombre",
  jobSummaryPerms = "%s permisos entre %s rangos",
  jobSummaryRoles = "%s roles vinculados a rangos del trabajo",
  noPermissionsAssigned = "Aún no hay permisos asignados",
  usedVehiclesMenu = "Vehículos usados",
  vehicleType = "Tipo de vehículo",
  newVehicle = "Nuevo",
  usedVehicle = "Usado",
  usedVehiclesStockMenu = "Vehículos usados",
  usedVehiclesPendingStockMenu = "Stock usado pendiente",
  usedVehiclesAuctionsMenu = "Subastas",
  usedVehiclesOffersMenu = "Ofertas",
  openUsedVehiclesManagement = "Abrir gestión de vehículos usados",
  usedVehiclesIntegrationUnavailable = "JG Used Vehicles no está disponible actualmente.",
  usedVehiclesOpenFailed = "No se pudo abrir la gestión de vehículos usados.",
  usedVehiclesTradeIns = "Vehículos a cambio",
  usedVehiclesTradeInsEnabled = "Permitir vehículos a cambio en ventas directas",
  usedVehiclesAllowFinancePayoffTradeIns = "Permitir vehículos financiados a cambio",
  usedVehiclesMaxTradeInAppraisal = "Tasación máxima del vehículo entregado",
  failedToSaveDealership = "No se pudo guardar el concesionario. Inténtalo de nuevo.",
  newVehicles = "Vehículos nuevos",
  newVehiclesDescription = "Explora y compra el stock nuevo del concesionario.",
  displayDivisionNew = "Nuevo",
  displayDivisionUsed = "Usado",
  vehiclesSold = "vehículos vendidos",
  photos = "Fotos",
  takePhoto = "Hacer fotos",
}
