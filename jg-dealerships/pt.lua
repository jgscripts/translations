...
Locales['pt'] = {
  ...
  down = "Baixo",
  confirm = "Confirmar",
  editPolygonVertices = "Editar vértices do polígono",
  walkToEachPointCreateZone = "Vá até cada ponto e adicione-o para criar uma zona",
  ...
  keyScroll = "Roda do rato",
  keyEnter = "Enter",
  keyEscape = "Esc",
  keyLeftRight = "Esquerda / Direita",
  expand = "Expandir",
  collapse = "Recolher",
  ...
  dealershipNameTooLong = "O nome do concessionário não pode exceder 100 caracteres.",
  generalSettings = "Geral",
  invalidCommission = "Introduza uma comissão entre 0 e 100.",
  savingChanges = "A guardar alterações...",
  automaticallySaved = "Guardado automaticamente",
  settingsUpdateFailed = "Não foi possível guardar as definições gerais.",
  unsavedChanges = "Tem alterações não guardadas",
  unsavedChangesDescription = "Tem a certeza de que pretende sair? Todas as alterações não guardadas serão perdidas.",
  keepEditing = "Continuar a editar",
  discardChanges = "Descartar alterações",
  commissionPaymentFailed = "Não foi possível pagar a comissão porque o saldo do concessionário é demasiado baixo.",
  setupJob = "Configurar emprego",
  setupJobDesc = "Associe este concessionário a um emprego do framework e configure as permissões dos níveis",
  setupJobOptionalDesc = "Associe opcionalmente os cargos do concessionário a um emprego do framework",
  jobSetupRequired = "Tem de configurar um emprego antes de continuar",
  jobMustBeValidated = "Não foi possível validar o emprego; verifique o respetivo nome",
  jobSummaryPerms = "%s permissões em %s níveis",
  jobSummaryRoles = "%s cargos associados aos níveis do emprego",
  noPermissionsAssigned = "Ainda não foram atribuídas permissões",
  usedVehiclesMenu = "Veículos usados",
  vehicleType = "Tipo de veículo",
  newVehicle = "Novo",
  usedVehicle = "Usado",
  usedVehiclesStockMenu = "Veículos usados",
  usedVehiclesPendingStockMenu = "Stock usado pendente",
  usedVehiclesAuctionsMenu = "Leilões",
  usedVehiclesOffersMenu = "Ofertas",
  openUsedVehiclesManagement = "Abrir gestão de veículos usados",
  usedVehiclesIntegrationUnavailable = "O JG Used Vehicles não está disponível neste momento.",
  usedVehiclesOpenFailed = "Não foi possível abrir a gestão de veículos usados.",
  usedVehiclesTradeIns = "Retomas",
  usedVehiclesTradeInsEnabled = "Ativar retomas para vendas diretas",
  usedVehiclesAllowFinancePayoffTradeIns = "Permitir retomas de veículos financiados",
  usedVehiclesMaxTradeInAppraisal = "Avaliação máxima de retoma",
  failedToSaveDealership = "Não foi possível guardar o concessionário. Tente novamente.",
  newVehicles = "Veículos novos",
  newVehiclesDescription = "Consulte e compre o stock novo do concessionário.",
  displayDivisionNew = "Novo",
  displayDivisionUsed = "Usado",
  vehiclesSold = "veículos vendidos",
  photos = "Fotografias",
  takePhoto = "Tirar fotografias",
}
